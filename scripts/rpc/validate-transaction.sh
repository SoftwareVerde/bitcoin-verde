...
(echo "{\"method\":\"POST\",\"query\":\"VALIDATE_TRANSACTION\",\"parameters\":{\"transactionData\":\"${TRANSACTION_DATA}\",\"enableSlpValidation\":\"${ENABLE_SLP_VALIDATION}\"}}") | curl -s --http0.9 --data-binary @- localhost:8334
