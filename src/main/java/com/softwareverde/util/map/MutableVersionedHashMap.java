...
public class MutableVersionedHashMap<Key, Value> implements VersionedMap<Key, Value> {
    ...
    public static <Key, Value> MutableVersionedHashMap<Key, Value> wrap(final HashMap<Key, Value> hashMap) {
    ...
    public static <Key, Value> MutableVersionedHashMap<Key, Value> wrap(final MutableVersionedHashMap<Key, Value> hashMap) {
        return new MutableVersionedHashMap<>(hashMap._committedValues);
    }
    ...
    protected MutableVersionedHashMap(final HashMap<Key, Value> hashMap) {
