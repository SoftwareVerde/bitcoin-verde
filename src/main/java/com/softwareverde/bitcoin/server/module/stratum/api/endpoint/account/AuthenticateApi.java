...
public class AuthenticateApi extends AuthenticatedServlet {
    public static final Integer MIN_PASSWORD_LENGTH = 8;

    protected final MysqlDatabaseConnectionFactory _databaseConnectionFactory;

    public AuthenticateApi(final Configuration.StratumProperties stratumProperties, final ThreadPool threadPool, final MysqlDatabaseConnectionFactory databaseConnectionFactory) {
