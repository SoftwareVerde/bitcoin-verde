...
//
//    @Override
//    public SlpTokenId getSlpTokenId(final Object transactionOutputId) throws DatabaseException {
//        final DatabaseConnection databaseConnection = _databaseManager.getDatabaseConnection();
//        final TransactionDatabaseManager transactionDatabaseManager = _databaseManager.getTransactionDatabaseManager();
//
//        final java.util.List<Row> rows = databaseConnection.query(
...
//
//    @Override
//    public void setSlpTransactionId(final TransactionId slpTokenTransactionId, final Object transactionOutputId) throws DatabaseException {
//        final DatabaseConnection databaseConnection = _databaseManager.getDatabaseConnection();
//
//        databaseConnection.executeSql(
...
//
//    @Override
//    public void setSlpTransactionIds(final TransactionId slpTokenTransactionId, final List<Object> transactionOutputIds) throws DatabaseException {
//        final DatabaseConnection databaseConnection = _databaseManager.getDatabaseConnection();
//
//        databaseConnection.executeSql(
