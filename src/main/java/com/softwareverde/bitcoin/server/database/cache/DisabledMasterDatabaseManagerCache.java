...
public class DisabledMasterDatabaseManagerCache implements MasterDatabaseManagerCache {
    protected final Cache<TransactionId, ConstTransaction> _transactionCache = new DisabledCache<>();
    protected final Cache<ImmutableSha256Hash, TransactionId> _transactionIdCache = new DisabledCache<>();
    ...
    @Override
    public Cache<ImmutableSha256Hash, TransactionId> getTransactionIdCache() {
