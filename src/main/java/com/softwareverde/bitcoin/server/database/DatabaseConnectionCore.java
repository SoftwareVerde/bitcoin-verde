...
public abstract class DatabaseConnectionCore implements DatabaseConnection {
    protected final com.softwareverde.database.DatabaseConnection<Connection> _core;

    public DatabaseConnectionCore(final com.softwareverde.database.DatabaseConnection<Connection> core) {
        _core = core;
    }
