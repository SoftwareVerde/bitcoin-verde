...
public abstract class Operation implements Const {
    ...
    public enum Type {
        ...
        OP_COMPARISON   (INTEGER_AND, INTEGER_OR, IS_EQUAL, IS_EQUAL_THEN_VERIFY, IS_FALSE, IS_NUMERICALLY_EQUAL, IS_NUMERICALLY_EQUAL_THEN_VERIFY, IS_NUMERICALLY_NOT_EQUAL, IS_LESS_THAN, IS_GREATER_THAN, IS_LESS_THAN_OR_EQUAL, IS_GREATER_THAN_OR_EQUAL, IS_WITHIN_RANGE),
