...
public class BlockValidatorContext implements BlockHeaderContext, ChainWorkContext, MedianBlockTimeContext, NetworkTimeContext, UnspentTransactionOutputContext {
    ...
    public BlockValidatorContext(final BlockchainSegmentId blockchainSegmentId, final UnspentTransactionOutputContext unspentTransactionOutputContext, final DatabaseManager databaseManager, final NetworkTime networkTime) {
