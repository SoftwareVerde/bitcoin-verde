...
public class BlockHeaderInflater {
    protected MutableBlockHeader _fromByteArrayReader(final ByteArrayReader byteArrayReader) {
        ...
        blockHeader._previousBlockHash = new ImmutableHash(byteArrayReader.readBytes(32, Endian.LITTLE));
        blockHeader._merkleRoot = new ImmutableMerkleRoot(byteArrayReader.readBytes(32, Endian.LITTLE));
