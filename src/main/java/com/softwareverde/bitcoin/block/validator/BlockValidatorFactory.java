...
public interface BlockValidatorFactory {
    ...
    BlockHeaderValidator newBlockHeaderValidator(FullNodeDatabaseManager databaseManager, NetworkTime networkTime, MedianBlockTimeWithBlocks medianBlockTime);
}
