...
CREATE TABLE utxo_commitment_files (
    id INT UNSIGNED NOT NULL AUTO_INCREMENT,
    utxo_commitment_id INT UNSIGNED NOT NULL,
    bucket_index INT UNSIGNED NOT NULL,
    public_key BINARY(33) NOT NULL,
    utxo_count INT NOT NULL,
    byte_count INT NOT NULL,
    PRIMARY KEY (id),
    UNIQUE KEY utxo_commitment_files_uq (utxo_commitment_id, bucket_index),
    FOREIGN KEY utxo_commitment_file_fk (utxo_commitment_id) REFERENCES utxo_commitments (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=LATIN1;
...
INSERT INTO metadata (version, timestamp) VALUES (7, UNIX_TIMESTAMP());
