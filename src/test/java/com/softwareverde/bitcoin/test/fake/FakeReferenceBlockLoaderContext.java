...
public class FakeReferenceBlockLoaderContext implements AsertReferenceBlockLoader.ReferenceBlockLoaderContext {
    ...
    public void setBlockHeader(final BlockchainSegmentId blockchainSegmentId, final BlockId blockId, final Long blockHeight, final MedianBlockTime medianBlockTime, final Difficulty difficulty) {
