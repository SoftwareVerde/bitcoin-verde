...
public class BlockMessageInflaterTests {
    ...
    public void should_inflate_genesis_block_message_from_byte_array() {
        ...
        final BlockMessageInflater blockMessageInflater = new BlockMessageInflater(coreInflater);
        ...
        Assert.assertEquals(1, transactions.getCount());
        ...
        Assert.assertEquals(1, transactionInputs.getCount());
        ...
        Assert.assertEquals(1, transactionOutputs.getCount());
