...
public class BlockDownloadPlannerCoreTests extends UnitTest {
    ...
    public void should_download_genesis_block_when_no_blocks_available() throws Exception {
        ...
        final BlockDownloadPlannerCore blockDownloadPlanner = new BlockDownloadPlannerCore(new Blockchain(blockStore), blockStore);
    ...
    public void should_download_alternate_blocks_with_sufficient_work() throws Exception {
        ...
        blockchain.defineBlock(Block.GENESIS_BLOCK_HASH, 0L);
        ...
        { // Main Chain head Block...
            ...
            blockchain.defineBlock(blockHash, blockHeight);
        }
        ...
        final BlockDownloadPlannerCore blockDownloadPlanner = new BlockDownloadPlannerCore(blockchain, blockStore);
...
class MockBlockStore implements FakeBlockStore {
    ...
    public Long getBlockByteCount(final Sha256Hash blockHash, final Long blockHeight) {
        if (_existingBlocks.get(blockHash)) {
            return BlockHeaderInflater.BLOCK_HEADER_BYTE_COUNT.longValue();
        }
        return 0L;
    }
