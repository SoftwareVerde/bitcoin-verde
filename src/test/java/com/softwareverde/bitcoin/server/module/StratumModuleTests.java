...
public class StratumModuleTests {
    ...
    public void should_mine_valid_prototype_block() {
        ...
        stratumModule.setValidatePrototypeBlockBeforeMining(false);

        stratumModule.queueFakeJsonResponse(Json.parse("{\"blockHeaders\":[\"00000020491C708BADFD38F0B38A6EDD6FDD949C9A4D109C037EAB010000000000000000093CC8AEF901A2BF304DC6949439AAC6942F75BE376E14E7C38EEA8F0D2B696360C6555C3C9B051848B94556\"],\"errorMessage\":null,\"wasSuccess\":1}"));
        stratumModule.queueFakeJsonResponse(Json.parse("{\"blockHeight\":568009,\"blockHeaderHeight\":568009,\"errorMessage\":null,\"wasSuccess\":1}"));
        stratumModule.queueFakeJsonResponse(Json.parse("{\"difficulty\":\"180597F0\",\"errorMessage\":null,\"wasSuccess\":1}"));
        stratumModule.queueFakeJsonResponse(Json.parse("{\"errorMessage\":null,\"blockReward\":1250000000,\"wasSuccess\":1}"));
        ...
        stratumModule.queueFakeJsonResponse(Json.parse("{\"errorMessage\":\"\",\"wasSuccess\":0}")); // Fail the ADD_HOOK upgrade since the socket is not real...
