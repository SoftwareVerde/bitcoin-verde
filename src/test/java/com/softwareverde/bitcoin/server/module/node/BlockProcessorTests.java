...
public class BlockProcessorTests extends IntegrationTest {
    ...
    public void should_handle_replicated_delayed_deep_reorg_with_synced_headers_with_semi_real_blocks() throws Exception {
        ...
        final FullNodeDatabaseManagerFactory databaseManagerFactory = new FullNodeDatabaseManagerFactory(_databaseConnectionFactory, _database.getMaxQueryBatchSize(), _blockStore, _utxoCommitmentOutputDirectory, _masterInflater, _checkpointConfiguration) {
