...
public class BlockValidatorContextTests extends IntegrationTest {
    ...
    public void should_return_correct_MedianBlockTime() throws Exception {
        ...
        try (final FullNodeDatabaseManager databaseManager = _fullNodeDatabaseManagerFactory.newDatabaseManager()) {
            final LazyBlockValidatorContext blockValidatorContext = new LazyBlockValidatorContext(_masterInflater, blockchainSegmentId, null, _difficultyCalculatorFactory, null, databaseManager, null);
