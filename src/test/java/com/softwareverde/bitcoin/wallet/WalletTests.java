...
public class WalletTests /* extends IntegrationTest */ {
    @Before
    public void setup() {
        // _resetDatabase();
    }
    ...
    public void should_suggest_spending_two_outputs_when_amount_plus_fee_is_2_satoshis_greater_than_send_amount() {
        ...
        Assert.assertEquals(456L, calculatedFees);
...
//        final BlockDatabaseManager blockDatabaseManager = new BlockDatabaseManager(databaseConnection, new DisabledDatabaseManagerCache());
...
//        }
//
//        final TransactionDatabaseManager transactionDatabaseManager = new TransactionDatabaseManager(databaseConnection, new DisabledDatabaseManagerCache());
//        final TransactionInflater transactionInflater = new TransactionInflater();
...
//
//        final TransactionValidator transactionValidator = new TransactionValidator(databaseConnection, new DisabledDatabaseManagerCache(), networkTime, medianBlockTime);
